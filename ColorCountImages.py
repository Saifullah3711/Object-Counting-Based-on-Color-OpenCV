...
image = cv2.imread('Images/ObjectImg.jpg')
image = cv2.resize(image, (960, 540))

#=========================================================================
lower_yellow = np.array([18, 98, 59]) 
upper_yellow = np.array([36, 255, 255])

lower_green = np.array([44, 154, 40])
upper_green = np.array([67, 255, 255])

lower_red = np.array([0, 89, 0])   
...
def ContourCalculate(image):
    ...
    for b in cntr4:
        ...
        if area1>1600:
            ...
            lengthBlue +=1
    cv2.putText(image,f'Yellow: {lengthYellow}', (20, 100),cv2.FONT_HERSHEY_SIMPLEX, 2.5, (0, 255, 255),3 )
    cv2.putText(image,f'Green: {lengthGreen}', (20, 160),cv2.FONT_HERSHEY_SIMPLEX, 2.5, (0, 255, 0),3 )
    cv2.putText(image,f'Red: {lengthRed}', (20, 220),cv2.FONT_HERSHEY_SIMPLEX, 2.5, (0, 0, 255),3 )
    cv2.putText(image,f'Blue: {lengthBlue}', (20, 280),cv2.FONT_HERSHEY_SIMPLEX, 2.5, (255, 0, 0),3 )
    return image
